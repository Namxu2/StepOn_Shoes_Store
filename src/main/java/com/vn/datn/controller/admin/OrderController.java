...
import com.vn.datn.dto.OrderExcelExporter;
import com.vn.datn.entities.Order;
import com.vn.datn.entities.OrderDetail;
import com.vn.datn.entities.Product;
import com.vn.datn.entities.User;
import com.vn.datn.repository.OrderDetailRepository;
...
import com.vn.datn.service.OrderDetailService;
import com.vn.datn.service.SendMailService;
...
public class OrderController {
	...
	public ModelAndView cancel(ModelMap model, @PathVariable("order_id") Long id) {
		...
		Order oReal = o.get();
		oReal.setStatusTransport((short) 3);
	...
	public ModelAndView confirm(ModelMap model, @PathVariable("order_id") Long id) {
		...
		Order oReal = o.get();
		oReal.setStatusTransport((short) 1);
		orderRepository.save(oReal);
	...
	public ModelAndView delivered(ModelMap model, @PathVariable("order_id") Long id) {
		...
		Order oReal = o.get();
		oReal.setStatusTransport((short) 2);
		orderRepository.save(oReal);
